/*
  ...
  to format the output. Create a program to generate the bill invoice of a department
...
int main()
{
  ...
  bill << setw(40) << "S COMPANY LIMITED" << endl;
  cout << setw(40) << "S COMPANY LIMITED" << endl;
  int sno = 1;
  char part[20];
  int qt;
  float price;
